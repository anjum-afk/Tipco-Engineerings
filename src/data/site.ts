...
export const PRODUCTS: Product[] = [
  ...
  // Laboratory Machines
  { name: 'Lab High Speed Disperser', slug: 'lab-high-speed-disperser', href: '/laboratory-machines/lab-high-speed-disperser', img: `${CDN}/public/productwork/Dispersers%20for%20Paint.png`, desc: 'Lab High Speed Disperser is mainly used in industrial departments and small-scale R&D laboratories for mixing and dispersing.', categorySlug: 'laboratory-machines' },
  { name: 'Lab Attritor Mill', slug: 'lab-attritor-mill', href: '/laboratory-machines/lab-attritor-mill', img: `${CDN}/public/productwork/Lab%20Attritor%20Mill%20(1).png`, desc: 'Tipco Engineering Lab Attritor Mill Machine is used for high output lab-scale grinding.', categorySlug: 'laboratory-machines' },
  { name: 'Lab Mixer', slug: 'lab-mixer', href: '/laboratory-machines/lab-mixer', img: `${CDN}/public/productwork/lab-mixer.png`, desc: 'Tipco Engineering Lab Mixer Machine is used for high output mixing in laboratory settings.', categorySlug: 'laboratory-machines' },
  { name: 'Lab Basket Mill', slug: 'lab-basket-mill', href: '/laboratory-machines/lab-basket-mill', img: `${CDN}/public/productwork/Lab%20Basket%20Mill%20(1).png`, desc: 'Basket Mill (Hydraulic Lifting) wet grinding machine in a compact lab-scale format.', categorySlug: 'laboratory-machines' },
  { name: 'Lab Ribbon Blender', slug: 'lab-ribbon-blender', href: '/laboratory-machines/lab-ribbon-blender', img: `${CDN}/public/productwork/Lab%20Ribbon%20Blender.jpg`, desc: 'We offer a premium quality Lab Ribbon Blender Mixer for uniform dry powder blending.', categorySlug: 'laboratory-machines' },
